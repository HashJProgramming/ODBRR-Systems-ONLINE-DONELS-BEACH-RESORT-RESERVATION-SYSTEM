...
<head>
    ...
    <title>Home - ODBRR Systems</title>
...
<body>
    <nav class="navbar navbar-light navbar-expand-md sticky-top navbar-shrink py-3" id="mainNav">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><span class="bs-icon-sm bs-icon-circle bs-icon-primary shadow d-flex justify-content-center align-items-center me-2 bs-icon"><i class="fas fa-umbrella-beach"></i></span><span>ONLINE DONELS BEACH RESORT RESERVATION SYSTEM</span></a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="navbar-nav mx-auto"></ul><button class="btn btn-primary shadow" type="button" style="margin-right: 5px;" data-bs-target="#signin" data-bs-toggle="modal">Sign In</button><button class="btn btn-primary shadow" type="button" data-bs-target="#signup" data-bs-toggle="modal">Sign Up</button>
            </div>
        </div>
    </nav>
                ...
                <div class="row g-0">
                    <div class="col-md-6">
                        <div class="text-white p-4 p-md-5">
                            <h2 class="fw-bold text-white mb-3">Donel's Beach Resort</h2>
                            <p class="mb-4">Celebrate with an enjoyable time at Donels Beach Resort featuring 5 Course Meal and desserts and much more. Enjoy access to the swimming pool, and beach</p>
                        </div>
                    </div>
    ...
    <footer class="bg-primary-gradient">
        <div class="container py-4 py-lg-5">
            ...
            <div class="text-muted d-flex justify-content-between align-items-center pt-3">
                <p class="mb-0">Copyright © 2023 ONLINE DONELS BEACH RESORT RESERVATION SYSTEM</p>
                ...
                <div class="modal-body">
                    <div class="p-5">
                        ...
                        <form class="user" action="functions/register.php" method="post">
                            ...
                            </div><input class="form-control form-control-user" type="tel" pattern="^(?!\s).*$" placeholder="Phone" required="" name="phone">
